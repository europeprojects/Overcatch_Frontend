...
const headCells = [
	{ id: 'companyType', align: 'left', numeric: false, disablePadding: false, label: 'Client Type' },
	{ id: 'companyName', align: 'left', numeric: false, disablePadding: false, label: 'Client Aggrement' },
	{ id: 'namesurname', align: 'left', numeric: false, disablePadding: false, label: 'Visa Type' },
...
export default function CompanyTable(props: any) {
	...
	// function handledetails(company: any) {
	//     history.push(`/tasks/${company.id}`);
	// }
		...
		<div className={classes.root}>
					...
					>
						...
						<TableBody>
							{stableSort(companies, getComparator(order, orderBy))
								...
								.map((company, index) => {
									const isItemSelected = isSelected(companies.id);
									...
									return (
										...
										>
											...
											<TableCell scope="row">{company.companyClientType.clientType}</TableCell>
											<TableCell>{company.companyClientType.agreementType}</TableCell>
											<TableCell>{company.companyClientType.visaType}</TableCell>
											<TableCell>
			...
			>
				...
				<DialogActions>
					...
					<Button onClick={goCreate} color="primary">
						{t('CONTINUE')}
					</Button>
				</DialogActions>
			</Dialog>
