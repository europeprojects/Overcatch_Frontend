...
function InProgressTasks(props:any) {
    ...
    const emptyRows =
        page > 0 ? Math.max(0, (1 + page) * rowsPerPage - inProgress?.length) : 0;
    ...
    useEffect(()=>{
        api.getInProgressTasks().then((resp)=>{
...
export default withSnackbar(InProgressTasks);