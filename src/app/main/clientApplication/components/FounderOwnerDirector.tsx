...
import {FounderOwner, Client} from "../../../types/UserModel";
...
import {directorDetailSheme} from "../../validations/ValidationSchemes";
...
export default function FounderOwnerDirector({
                                                 onInput,
                                                 handleBack,
                                                 handleNext,
                                                 formDetail,
                                                 client
                                             }: FounderOwnerDetailFormProps) {
    ...
    useEffect(() => {
        ...
        formik.values.maritalStatus = formDetail.maritalStatus
        ...
        formik.values.workStartDate = formDetail.workStartDate
    }, [])
    ...
    function handleSubmitChange(model: FounderOwner) {
        onInput(model)
    }
    ...
    function handleSubmit(model: FounderOwner) {
        ...
        model.workStartDate = formik.values.workStartDate
        handleNext()
        onInput(model)
    }
                    ...
                    {client?.clientTypeEnum.toString() == "SOLETRADE"  &&
                        (
                            <TextField
                                ...
                                type="date"
                                name="workStartDate"
                                value={formik.values.workStartDate}
                                error = {formik.touched.workStartDate && Boolean(formik.errors.workStartDate)}
                                helperText={formik.touched.workStartDate && formik.errors.workStartDate}
