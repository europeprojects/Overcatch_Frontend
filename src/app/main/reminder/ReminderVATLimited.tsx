...
const headCells = [
    { id: 'code', numeric: false, disablePadding: true, label: 'Company VAT Number' },
    { id: 'name', numeric: true, disablePadding: false, label: 'Company Name' },
    { id: 'period', numeric: true, disablePadding: false, label: 'Company VAT Period' },
    { id: 'date', numeric: true, disablePadding: false, label: 'Company VAT Register Date' },
                ...
                <TableContainer>
                    ...
                    >
                        ...
                        <TableBody>
                                    ...
                                    return (
                                        ...
                                        >
                                            <TableCell component="th" id={labelId} scope="row" padding="none">
                                                {limitedReminderList?.company?.vatNumber}
                                            </TableCell>
                                            <TableCell align="right">{limitedReminderList?.company?.name}</TableCell>
                                            <TableCell align="right">{limitedReminderList?.company?.vatPeriod}</TableCell>
                                            <TableCell align="right">{limitedReminderList?.company?.vatRegisterDate}</TableCell>
                            ...
                            {/*   {emptyRows > 0 && (
                                <TableRow style={{ height: (dense ? 1 : 0) * emptyRows }}>
                                    <TableCell colSpan={6} />
                                </TableRow>
                            )}*/}
                        </TableBody>
