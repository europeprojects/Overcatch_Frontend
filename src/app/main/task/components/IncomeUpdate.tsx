...
function EnhancedTableHead(props) {
    ...
    const headCells = [
        ...
        {id: 'incomePrice', numeric: false, disablePadding: false, label: t('INCOMEAMOUNT')},
        ...
        {id: 'document', numeric: false, disablePadding: false, label: t('DOCUMENT')}
    ];
    return (
        <TableHead>
            <TableRow>
...
function IncomeUpdate(props: any) {
    ...
    const steps = [t('INCOMESTYPE'), t('CONFIRMATION')];
                        ...
                        <div className="flex flex-1 flex-col items-center sm:items-start">
                            ...
                            <div className="flex flex-col min-w-0 items-center sm:items-start">
                                <Typography className="text-16 sm:text-20 truncate">
                                    {t('INCOMEUPDATEREQUEST')}{` - ${window.atob(taskid)}`}
                                </Typography>
